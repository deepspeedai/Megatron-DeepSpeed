...
def update_rotary_pos_emb(seq_length):
    ...
    cos_part, sin_part = RotaryEmbedding(rotary_dim, theta=args.rope_theta)(seq_length)
    rotary_pos_emb = (cos_part.to(get_accelerator().current_device_name()), 
                  sin_part.to(get_accelerator().current_device_name()))
